...
public interface PaymentService {
    ...
    List<CustomerPaymentSummaryResponse> getMyPaymentsByBookingReference(
    ...
    CustomerPaymentDetailResponse processLocal(
            String paymentReference, LocalPaymentProcessRequest request, User user);
}
