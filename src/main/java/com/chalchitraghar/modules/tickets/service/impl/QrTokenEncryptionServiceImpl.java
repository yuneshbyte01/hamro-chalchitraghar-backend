...
public class QrTokenEncryptionServiceImpl implements QrTokenEncryptionService {
    ...
    public QrTokenEncryptionServiceImpl(TicketQrProperties properties) {
    ...
    public String encrypt(String rawToken) {
        ...
        try {
            ...
            throw new IllegalStateException("Unable to encrypt QR token", ex);
        }
    }
    ...
    public String decrypt(String encryptedToken) {
        try {
            ...
            if (parts.length != 4 || !"1".equals(parts[0]) || !properties.keyId().equals(parts[1]))
            ...
            throw new IllegalStateException("Unable to decrypt QR token", ex);
        }
    }

    private byte[] aad() {
        return ("ticket-qr|1|" + properties.keyId()).getBytes(StandardCharsets.UTF_8);
    }
}
