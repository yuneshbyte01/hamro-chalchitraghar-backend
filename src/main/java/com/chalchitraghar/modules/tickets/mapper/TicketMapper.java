...
public class TicketMapper {
    ...
    public CustomerTicketDetailResponse toCustomerDetail(Ticket t) {
        return new CustomerTicketDetailResponse(t.getTicketReference(), t.getBooking().getBookingReference(), seatCode(t),
                ...
                t.getStatus(), t.getStatus()==com.chalchitraghar.modules.tickets.enums.TicketStatus.CHECKED_IN,
                t.getCheckedInAt(), t.getQrTokenVersion(), t.getIssuedAt());
    }
    ...
    public StaffTicketDetailResponse toStaffDetail(Ticket t) { return toStaffDetail(t,List.of()); }
    public StaffTicketDetailResponse toStaffDetail(Ticket t,List<TicketValidation> history) {
        ...
        return new StaffTicketDetailResponse(t.getTicketReference(), t.getBooking().getBookingReference(), u.getId(),
                ...
                t.getRevocationReason(), t.getCreatedAt(), t.getUpdatedAt(), mapHistory(history));
    }
    ...
    public AdminTicketDetailResponse toAdminDetail(Ticket t) { return toAdminDetail(t,List.of()); }
    ...
    private List<TicketValidationHistoryResponse> mapHistory(List<TicketValidation> history){return history.stream().map(v->new TicketValidationHistoryResponse(v.getResult(),v.getReason(),v.getValidationTime(),v.getValidatedBy().getId(),v.getValidatedBy().getName(),v.getDeviceId(),v.getLocation(),v.getRequestId())).toList();}
}
