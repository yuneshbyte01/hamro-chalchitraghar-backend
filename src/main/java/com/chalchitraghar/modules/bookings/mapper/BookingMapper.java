...
public class BookingMapper {
    ...
    public CustomerBookingSummaryResponse toCustomerSummary(Booking b, List<BookingSeat> seats) {
        ...
        return new CustomerBookingSummaryResponse(
                ...
                showDateTime(b),
                ordered.stream().map(bs -> bs.getSeat().getSeatCode()).toList(),
                b.getTotalAmount(),
                b.getCurrency(),
                b.getBookingTime(),
                b.getExpiresAt());
    ...
    public CustomerBookingDetailResponse toCustomerDetail(Booking b, List<BookingSeat> seats) {
        return new CustomerBookingDetailResponse(
                ...
                b.getShow().getHall().getName(),
                showDateTime(b),
                b.getShow().getShowTime().toString(),
                b.getShow().getEndTime().toString(),
                mapSeats(seats),
                b.getTotalAmount(),
                b.getCurrency(),
                b.getBookingTime(),
