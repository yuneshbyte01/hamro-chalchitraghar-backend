...
public class HallRequest {
    ...
    @Schema(
            example = "Hall A",
            description = "Unique hall name. Leading and trailing whitespace is trimmed.")
    private String name;
    ...
    @Schema(
            example = "standard_8x10",
            maxLength = 100,
            description =
                    "Letters, numbers, hyphen, and underscore only. Leading and trailing whitespace is trimmed.")
