...
public class AdminHallController {
    ...
    @Operation(
            ...
            description =
                    "Returns paginated admin hall summaries. Search matches name and layoutRef case-insensitively.")
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200",
            description = "Admin halls fetched",
    ...
    public ResponseEntity<ApiResponse<PageResponse<AdminHallSummaryResponse>>> getAllHalls(
            ...
            @Parameter(
                            description =
                                    "Case-insensitive search term matched against hall name and layoutRef")
                    @RequestParam(required = false)
                    String search,
            @Parameter(description = "Filter by status: ACTIVE, INACTIVE")
                    @RequestParam(required = false)
                    String status) {
        PageResponse<AdminHallSummaryResponse> halls =
                hallService.getAdminHalls(
                        new HallSearchCriteria(search, status), page, size, sortBy, sortDir);
    ...
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200",
            description = "Admin hall fetched",
    ...
    public ResponseEntity<ApiResponse<AdminHallDetailResponse>> getHallById(@PathVariable Long id) {
        return ResponseEntity.ok(
                ApiResponse.success("Hall fetched successfully", hallService.getAdminHallById(id)));
    }
    ...
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200",
            description = "Active admin halls fetched",
            content = @Content(schema = @Schema(implementation = AdminHallSummaryResponse.class)))
    public ResponseEntity<ApiResponse<List<AdminHallSummaryResponse>>> getActiveHalls() {
        return ResponseEntity.ok(
                ApiResponse.success(
                        "Active halls fetched successfully", hallService.getAdminActiveHalls()));
    }
    ...
    @Operation(
            ...
            description =
                    "Creates a hall after validating unique name, capacity, layout reference, and status.")
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "201",
    ...
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "409",
            description = "Duplicate hall name")
    public ResponseEntity<ApiResponse<AdminHallDetailResponse>> createHall(
            @Valid @RequestBody HallRequest dto) {
    ...
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "409",
            description =
                    "Duplicate hall name, invalid lifecycle transition, future active shows exist, or seat template dependency blocks capacity/layoutRef changes")
    public ResponseEntity<ApiResponse<AdminHallDetailResponse>> updateHall(
            @PathVariable Long id, @Valid @RequestBody HallRequest dto) {
        return ResponseEntity.ok(
                ApiResponse.success("Hall updated successfully", hallService.updateHall(id, dto)));
    }
    ...
    @Operation(
            ...
            description =
                    "Marks the hall as INACTIVE when no future active SCHEDULED or RUNNING shows exist. Hall rows are not physically deleted.")
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "204",
            description = "Hall marked inactive")
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "404",
            description = "Hall not found")
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "409",
            description = "Hall has future active shows")
