...
public class AdminBookingController {
    ...
    @GetMapping
    @Operation(
            summary = "List bookings for admins",
            description =
    ...
    @Operation(
            ...
            description = "Requires ADMIN role and returns safe operational booking details.")
    public ResponseEntity<ApiResponse<AdminBookingDetailResponse>> getBookingById(
            @PathVariable Long bookingId) {
        return ResponseEntity.ok(
                ApiResponse.success(
                        "Booking fetched successfully",
                        bookingService.getAdminBookingById(bookingId)));
    }
