...
abstract class AbstractIntegrationTest {
    ...
    @Autowired protected NotificationDeliveryRepository notificationDeliveryRepository;
    ...
    @Autowired protected SeatTemplateRepository seatTemplateRepository;
    ...
    @Autowired protected TicketDeliveryRepository ticketDeliveryRepository;
    ...
    void cleanDatabase() {
        ...
        refundAttemptRepository.deleteAll();
    ...
    protected JsonNode postSeatLayout(Long hallId, String adminToken) throws Exception {
        MvcResult result =
                mockMvc.perform(
                                post("/api/admin/halls/{hallId}/seat-layout", hallId)
    ...
    protected Map<String, Object> hallRequest(
            String name, Integer capacity, String layoutRef, Status status) {
        return Map.of(
                "name", name,
                "capacity", capacity,
                "layoutRef", layoutRef,
    ...
    protected Map<String, Object> showRequest(
            Long movieId, Long hallId, int daysFromNow, String showTime, String endTime) {
        return Map.of(
                "movieId", movieId,
                "hallId", hallId,
    ...
    protected Payment saveSuccessfulPayment(
            com.chalchitraghar.modules.bookings.entity.Booking booking) {
        ...
        return paymentRepository.save(
                Payment.builder()
                        ...
                        .initiatedAt(java.time.LocalDateTime.now(clock))
                        .completedAt(java.time.LocalDateTime.now(clock))
                        .build());
    }
}
